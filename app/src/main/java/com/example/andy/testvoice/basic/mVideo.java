 ...
 */
public class mVideo {
    private static String TAG = "【" + mVideo.class + "】==";
    public static final String PRIVATE_SETTING = "com.iflytek.setting";           //缓存数据的名称
    private static volatile mVideo _singleton;
    ...
    private mVideo(Context context) {
        this.mContext = context;
    }

    public static mVideo get_Instance(Context context) {
        if (_singleton == null) {
            synchronized (mVideo.class) {
                if (_singleton == null) {
                    _singleton = new mVideo(context);
                }
            }
        }
        return _singleton;
